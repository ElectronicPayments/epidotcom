	...
	<div class="rev_slider_wrapper">
		<div class="company-intro-slider rev_slider"  data-version="5.0">
			<ul>
				<% loop $Slides %>
				<li>
					<img src="$SlidePhoto.URL"  alt="Background Image"  width="1920" height="1280">
                    $SlideContent
                </li>
				<% end_loop %>
            </ul>
							...
							<div class="box-promo">
								<div class="row">
									...
									<div class="col-xs-12 col-sm-6 col-md-7">
										<iframe class="testimonial-vid" width="560" height="315" src="https://youtube.com/embed/$Link?rel=0&wmode=transparent&vq=hd720autoplay=0&showinfo=0&controls=0"></iframe>
									</div>
								</div>
							</div>
						</div>
